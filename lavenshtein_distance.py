"""
This is the implementation of Lavenshten distance algorithm.

Usage: lavenshtein_distance().of("apple","banana")

Author: Prakash
Github: https://github.com/ppml38/lavenshtein_distance
This code is licensed under a permissive MIT license -- see LICENSE.txt.
"""

__all__ = ['lavenshtein_distance']
